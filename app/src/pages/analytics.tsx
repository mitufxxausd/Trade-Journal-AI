...
import {
  TrendingUp, TrendingDown, Target, DollarSign, Activity, BarChart3,
} from "lucide-react";
import {
...
export default function Analytics() {
  ...
  const statCards = [
    { title: "Net P&L", value: stats.netPnl, prefix: "$", icon: stats.netPnl >= 0 ? TrendingUp : TrendingDown, iconColor: stats.netPnl >= 0 ? "text-green-500" : "text-red-500" },
    { title: "Total Trades", value: stats.totalTrades, icon: Activity, iconColor: "text-blue-500" },
    { title: "Win Rate", value: stats.winRate.toFixed(1) + "%", icon: Target, iconColor: "text-purple-500" },
    { title: "Profit Factor", value: stats.profitFactor === Infinity ? "∞" : stats.profitFactor.toFixed(2), icon: BarChart3, iconColor: "text-amber-500" },
    { title: "Gross Profit", value: "$" + stats.totalProfit.toLocaleString(), icon: DollarSign, iconColor: "text-green-500" },
    { title: "Max Drawdown", value: "$" + stats.maxDrawdown.toLocaleString(), icon: TrendingDown, iconColor: "text-red-500" },
  ];
              ...
              {monthlyData.length > 0 ? (
                <ResponsiveContainer width="100%" height={300}>
                  <AreaChart data={monthlyData}>
                    <defs><linearGradient id="colorProfit2" x1="0" y1="0" x2="0" y2="1"><stop offset="5%" stopColor="#22c55e" stopOpacity={0.3} /><stop offset="95%" stopColor="#22c55e" stopOpacity={0} /></linearGradient></defs>
